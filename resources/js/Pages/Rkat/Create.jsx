...
import TextArea from '@/Components/TextArea'; // Asumsi Anda punya komponen TextArea
...
export default function RkatCreate({ 
    auth, tahunAnggarans, departemens, programKerjas, akunAnggarans 
}) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        waktu_pelaksanaan: '', // Jadwal Pelaksanaan
            ...
            <div className="py-12">
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <form onSubmit={submit} className="bg-white dark:bg-gray-800 p-8 shadow sm:rounded-lg space-y-6">
                        ...
                        {/* BARIS PROGRAM/KEGIATAN (Dropdown Proker) */}
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <InputLabel htmlFor="waktu_pelaksanaan" value="Jadwal Pelaksanaan" />
                                <TextInput
                                    id="waktu_pelaksanaan"
                                    type="date"
                                    value={data.waktu_pelaksanaan}
                                    onChange={(e) => setData('waktu_pelaksanaan', e.target.value)}
                                    className="mt-1 block w-full"
                                />
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <TextInput
                                    ...
                                    className="mt-1 block w-full"
                                />
                                {/* Catatan: Field ini tidak ada di DB, harus dipertimbangkan untuk diubah atau dihapus */}
                            </div>
                            <div>
