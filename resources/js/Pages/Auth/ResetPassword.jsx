    ...
    return (
        <GuestLayout>
            ...
            <div className="mb-6 text-center">
                ...
                <h2 className="text-xl font-bold text-slate-800 dark:text-white">Atur Ulang Kata Sandi</h2>
            ...
            <form onSubmit={submit} className="space-y-5">
                ...
                <div className="pt-2">
                    <PrimaryButton 
                        className="w-full flex justify-center py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-teal-500 dark:from-blue-700 dark:to-teal-600 font-bold shadow-lg shadow-blue-500/20 dark:shadow-blue-950/40 transition-all duration-300 hover:scale-[1.02] text-white dark:text-white" 
                        disabled={processing}
                    >
