...
export default function PencairanApprovalModal({ show, onClose, pencairan }) {
    ...
    const submit = (e) => {
        ...
        post(route('pencairan.approve', pencairan.uuid), {
            preserveScroll: true,
            onSuccess: () => {
                toast.success("Berhasil", { id: toastId, description: `Pencairan berhasil di${actionType.toLowerCase()}.` });
                reset();
                onClose();
            },
            onError: () => {
        ...
        <Modal show={show} onClose={onClose} maxWidth="lg">
            <form onSubmit={submit} className="p-6">
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4 border-b border-gray-200 dark:border-gray-700 pb-3">
                    Review Pencairan Dana: <span className="font-bold text-teal-600 dark:text-teal-400">{pencairan.rkat_header?.nomor_dokumen}</span>
                </h2>
                ...
                {actionType !== 'Setuju' && (
                    <div className="mb-4 animate-in fade-in slide-in-from-top-2 duration-200 bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg border border-gray-100 dark:border-gray-700">
                        ...
                        <textarea
                            ...
                            rows="4"
                            placeholder={actionType === 'Revisi' ? "Tuliskan bagian mana saja yang perlu diperbaiki..." : "Tuliskan alasan utama mengapa pengajuan ini ditolak..."}
                ...
                <div className="mt-6 flex justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
                    ...
                    {actionType === 'Setuju' && (
                        <PrimaryButton disabled={processing} className="bg-teal-600 hover:bg-teal-700 focus:ring-teal-500 text-white border border-transparent">
